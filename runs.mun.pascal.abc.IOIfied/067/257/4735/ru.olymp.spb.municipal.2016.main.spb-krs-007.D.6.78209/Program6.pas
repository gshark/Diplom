   ...
   for o:=1 to n do
    for p:=1 to n do
     for q:=1 to n do
      for w:=1 to n do
  begin
  if (i<>j) and (j<>g) and (i<>g) and (i<>o) and (j<>o) and (g<>o) and (i<>p) and (j<>p) and (g<>p) and (o<>p) and (i<>q) and (j<>q) and (g<>q) and (o<>q) and (p>q) and (i<>w) and (j<>w) and (g<>w) and (o<>w) and (p<>w) and (q<>w) then
  begin
  x:=i*j+j*g+g*o+o*p+p*q+q*w;
  y:=x mod k;
   if y=0 then
   b:=b+1;
  end;
