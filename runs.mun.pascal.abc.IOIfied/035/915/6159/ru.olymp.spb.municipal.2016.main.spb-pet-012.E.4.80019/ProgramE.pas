...
for i:=1 to c do begin
  ...
  if metall=n[lom,1,1] then begin n[lom,1,2]:=j; n[lom,2,2]:=i-j+1; end;  end; metall+=1;end; end;
    
for i:=1 to r-1 do begin
for j:=1 to r-i do begin
for lom:=1 to q do begin
  if metall=n[lom,1,1] then begin n[lom,1,2]:=j+i; n[lom,2,2]:=c-j+1; end;  end;metall+=1; end; end;
